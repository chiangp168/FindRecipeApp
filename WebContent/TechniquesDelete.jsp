...
<head>
    ...
    <title>Delete an Technique</title>
</head>
...
<body>
    ...
    <div class='container'>
        <div class="row">
            <div class="col-lg-12">
                <h3 class="text-dark">Delete Technique</h3>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="job-detail mt-2 p-4">
                    <div class="custom-form">
                        <form action="techniquesdelete" method="post">
                            <div class='row'>
                                <div class="col-md-6">
                                    <div <c:if test="${messages.disableSubmit}">style="display:none"</c:if>>
                                        <div class="form-group app-label">
                                            <label for="ingredientId" class="text-muted">Technique Id</label>
                                            <input id="techniqueId" type="text" class="form-control resume"
												name="techniqueId" value="${fn:escapeXml(param.techniqueId)}">
                                        </div>
                                    </div>
                                </div>
                                <p>
                                    <span id="submitButton" <c:if test="${messages.disableSubmit}">style="display:none"
                                        </c:if>>
                                        <input type="submit">
                                        <button class="btn btn-dark my-2 my-sm-0 button-search"

...
<body>
    ...
    <div class='container'>
	    <div class="row">
	        <div class="col-lg-12">
	            <h3 class="text-dark">Create a Recipe</h3>
	        </div>
	    </div>
                    	...
                    	<div class='row'>
                    		<div class="col-md-4">
	                        	<div class="form-group app-label">
	                            	<label for="recipename" class="text-muted">Recipe Name</label>
									<input id="recipename" type="text" class="form-control resume" name="recipename" value="">
	                           </div>
                        	</div>
							<div class="col-md-4">
								<div class="form-group app-label">
							...
							<div class="col-md-4">
								<div class="form-group app-label">
									<label for="timetocook" class="text-muted">Time to cook</label>
									<input id="timetocook" type="text" class="form-control resume" name="timetocook" value="">	
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group app-label">
									<label for="numberofsteps" class="text-muted">Number of step </label>
									<input id="numberofsteps" type="text" class="form-control resume" name="numberofsteps" value="">
								</div>
							</div>
						</div>
						<p>

...
<body>
	...
	<div class='container'>
		<div class="row">
			<div class="col-lg-12">
				<h3 class="text-dark">Update Ingredient</h3>
			</div>
		</div>
					...
					<div class="custom-form">
						<form action="ingredientsupdate" method="post">
							<div class='row'>
								...
								<div class="col-md-6">
									<div class="form-group app-label">
										<label for="ingredient" class="text-muted">New Ingredient</label>
										<input id="ingredient" type="text" class="form-control resume" name="ingredient"
											value="">
									</div>
								</div>
							</div>
							<p>
								<button class="btn btn-dark my-2 my-sm-0 button-search" type="submit">Update</button>
							</p>
						</form>
					</div>
					<p>

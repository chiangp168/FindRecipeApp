...
<body>
 ...
 <div class='container'>
	<div class="row">
		<div class="col-lg-12">
			<h3 class="text-dark">Create a Comment</h3>
		</div>
	</div>
				...
				<div class="custom-form">
					...
					<form action="usercreate" method="post">
						<div class='row'>
							...
							<div class="col-md-4">
								<div class="form-group app-label">
									<label for="userpassword" class="text-muted">User Password </label>
									<input id="userpassword" type="text" class="form-control resume" name="userpassword" value="">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group app-label">

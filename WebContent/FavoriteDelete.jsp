...
<div class='container'>
    <div class="row">
        <div class="col-lg-12">
            <h3 class="text-dark">Delete Favorite</h3>
        </div>
    </div>
                        ...
                        <div class='row'>
                            <div class="col-md-6">
                                <div class="form-group app-label">
                                    <label for="favoriteId" class="text-muted">Favorite Id</label>
                                    <input id="favoriteId" type="text" class="form-control resume" name="favoriteId" value="${fn:escapeXml(param.favoriteId)}">
                                </div>
                            </div>
                        </div>
                        <p>

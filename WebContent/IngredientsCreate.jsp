...
<body>
	...
	<div class='container'>
		<div class="row">
			<div class="col-lg-12">
				<h3 class="text-dark">Create ingredient</h3>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="job-detail mt-2 p-4">
					<div class="custom-form">
						...
						<form action="ingredientscreate" method="post">
							<div class='row'>
								<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group app-label">
										<label for="ingredient" class="text-muted">Ingredient</label>
										<input id="ingredient" name="ingredient" type="text" class="form-control resume"
											value="">
									</div>
								</div>
							</div>

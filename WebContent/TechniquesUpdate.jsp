...
<body>
	...
	<div class='container'>
		<div class="row">
			<div class="col-lg-12">
				<h3 class="text-dark">Update Technique</h3>
			</div>
		</div>
					...
					<div class="custom-form">
						<form action="ingredientsupdate" method="post">
							<div class='row'>
								...
								<div class="col-md-6">
									<div class="form-group app-label">
										<label for="technique" class="text-muted">New Technique</label>
										<input id="technique" type="text" class="form-control resume" name="technique"
											value="">
									</div>
								</div>
							</div>

...
<body>
    ...
    <div class='container'>
    	<div class="row">
	        <div class="col-lg-12">
	            <h3 class="text-dark">Update Moderator</h3>
	        </div>
	    </div>
                ...
                <h1>Update Moderator</h1>
                    <form action="moderatorupdate" method="post">
                    	<div class='row'>
							...
							<div class="col-md-6">
								<div class="form-group app-label">
									<label for="noAddRecipesDelete" class="text-muted">Number of recipe to add:</label>
									<input id="noAddRecipesDelete" type="text" class="form-control resume" name="noAddRecipesDelete" value="">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group app-label">

...
<body>
    ...
    <div class='container'>
        <div class="row">
            <div class="col-lg-12">
                <h3 class="text-dark">Delete Ingredient</h3>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="job-detail mt-2 p-4">
                    <div class="custom-form">
                        <form action="ingredientsdelete" method="post">
                            <div class='row'>
                                <div class="col-md-6">
                                    <div <c:if test="${messages.disableSubmit}">style="display:none"</c:if>>
                                        <div class="form-group app-label">
                                            <label for="ingredientId" class="text-muted">Ingredient Id</label>
                                            <input id="ingredientId" type="text" class="form-control resume"
                                                name="ingredientId" value="${fn:escapeXml(param.ingredientId)}">
                                        </div>
                                    </div>
                                </div>
                                <p>

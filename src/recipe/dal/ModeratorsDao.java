...
public class ModeratorsDao  extends PersonDao {
	...
	public Moderators updateLastName(Moderators moderator, String newLastName) throws SQLException {
		super.updateLastName(moderator, newLastName);
		return moderator;
	}
	
	public Moderators delete(Moderators moderator) throws SQLException {
		String deleteModerator = "DELETE FROM Moderators WHERE UserName=?;";
		Connection connection = null;
		PreparedStatement deleteStmt = null;
		try {
			connection = connectionManager.getConnection();
			deleteStmt = connection.prepareStatement(deleteModerator);
			deleteStmt.setString(1, moderator.getUserName());
